...
class JenkinsPromote extends Api {
    constructor(options) {
        ...
        super({
            ...
            promoteLink: '{baseUrl}/job/{promoteJob}/buildWithParameters?delay=20sec&&PROMOTED_JOB_NAME={project}.yml&ENVIRONMENT={environment}&AreYouSure=true&PROMOTED_NUMBER={buildId}'
        });
    }
