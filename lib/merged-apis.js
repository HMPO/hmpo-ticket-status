...
class MergedApis {
    constructor(config) {
        this.gitlabApi = new Gitlab(config.api('gitlab'));
        this.jiraApi = new Jira(config.api('jira'));
        this.jenkinsApi = new Jenkins(config.api('jenkins'));
        this.jenkinsPromoteApi = new JenkinsPromote(config.api('jenkinsPromote'));
    }
