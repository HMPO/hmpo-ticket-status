...
class MergedApis {
    constructor(config) {
        this.gitlabApi = new Gitlab(config.gitlab);
        this.jiraApi = new Jira(config.jira);
        this.jenkinsApi = new Jenkins(config.jenkins);
        this.jenkinsPromoteApi = new JenkinsPromote(config.jenkinsPromote);
    }
